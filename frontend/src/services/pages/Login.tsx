                  ...
                  <div className="col-12 py-2 align-self-end">
                    ...
                    <Form className="form">
                      ...
                      <p
                        ...
                        className="invalid-information fw-normal mb-2"
                      >
                      ...
                      >
                        ...
                        <div className="input-group">
                          <Form.Control
                            className={
                              isPasswordValid ? inputBorderPassword : ""
                            }
                      ...
                      <p
                        ...
                        className="invalid-information fw-normal mb-2"
                      >
                        Whoops! Incorrect password. Please try again.
                      </p>
                      <div className="forgetPassword pt-2 pb-4">
